...
interface AdminContentProps { onLock: () => void }

export default function AdminContent({ onLock }: AdminContentProps) {
    ...
    <div style={{ minHeight: '100vh', background: C.black, color: '#fff' }}>
      ...
      <div style={{ background: C.card, borderBottom: `1px solid ${C.dim}`, padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <button onClick={onLock} style={{ background: 'transparent', border: `1px solid ${C.dim}`, color: C.grey, fontFamily: "'Space Mono', monospace", fontSize: 10, padding: '6px 12px', borderRadius: 6, cursor: 'pointer' }}>
            LOCK
          </button>
        </div>
      </div>
