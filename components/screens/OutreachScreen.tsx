        ...
        {!started ? (
          ...
          <>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
              ...
              <button onClick={() => { setStarted(false); setMessages([]); setCurrentIndex(0) }} style={{ background: 'none', border: '1px solid rgba(255,255,255,0.06)', color: '#9CA3AF', fontFamily: 'monospace', fontSize: 10, padding: '4px 10px', borderRadius: 6, cursor: 'pointer' }}>
                ↺ RESET
              </button>
            </div>
